...
struct PlottableElements {
  ...
  double periapsis_distance;
  double apoapsis_distance;
  double lidov_c1;
  double lidov_c2;
  double eccentricity_cos_argument_of_periapsis;
  double eccentricity_sin_argument_of_periapsis;
};

static_assert(std::is_pod<PlottableElements>::value,
              "PlottableElements is used for interfacing");
...
extern "C" PRINCIPIA_DLL
PushPullExecutor<std::optional<DistinguishedPoints<World>::value_type>, Length, Angle, Angle>* __cdecl principia__CollisionNewFlightPlanExecutor(
    Plugin const* const plugin,
    int const celestial_index,
...
extern "C" PRINCIPIA_DLL
PushPullExecutor<std::optional<DistinguishedPoints<World>::value_type>, Length, Angle, Angle>* __cdecl principia__CollisionNewPredictionExecutor(
    Plugin const* const plugin,
    int const celestial_index,
    XYZ const sun_world_position,
    int const max_points,
...
extern "C" PRINCIPIA_DLL
void __cdecl principia__GetCPUIDFeatureFlags(
    bool* const has_avx,
    bool* const has_fma);
...
extern "C" PRINCIPIA_DLL
double __cdecl principia__GraphLidovFrozenLine(
    double const c2);

extern "C" PRINCIPIA_DLL
double __cdecl principia__GraphLidovMaximalEccentricityLine(
...
extern "C" PRINCIPIA_DLL
Plugin* __cdecl principia__PluginReaderAwait(
    PluginReader** const reader);

extern "C" PRINCIPIA_DLL
Plugin* __cdecl principia__PluginReaderGet(
    PluginReader** const reader);
