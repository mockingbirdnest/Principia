...
**[Galileo](https://github.com/mockingbirdnest/Principia/wiki/Change-Log#galileo), the June version of Principia, is available, with bug fixes.  Download it [here for 1.5.1, 1.6.1 and 1.7.x](https://bit.ly/3ddzZa8), and [here for 1.8.1 and 1.9.1](https://bit.ly/2Nsi45f).**

**For the convenience of Chinese users, downloads from 腾讯微云: [Principia Galileo for 1.5.1-1.7.3](https://share.weiyun.com/pz7pvNSt),  [Principia Galileo for 1.8.1-1.9.1](https://share.weiyun.com/WilijRta), [Trappist-1 for Principia](https://share.weiyun.com/5wVtWYQ).**
...
Download the binary (Ubuntu, macOS, and Windows) [here for 1.5.1, 1.6.1 and 1.7.x](https://bit.ly/3ddzZa8), and [here for 1.8.1 and 1.9.1](https://bit.ly/2Nsi45f).  Download the [“Trappist-1 for Principia”](https://github.com/mockingbirdnest/Principia/wiki/Installing,-reporting-bugs,-and-frequently-asked-questions#installing-trappist-1-for-principia) mini-mod [here](https://bit.ly/2ZHf3Tt).  Or, if you don't trust our binary, [build the mod](https://github.com/mockingbirdnest/Principia/blob/master/documentation/Setup.md) from the [Galileo](https://github.com/mockingbirdnest/Principia/releases/tag/2020062107-Galileo) release.
