...
**[Fano](https://github.com/mockingbirdnest/Principia/wiki/Change-Log#fano), the April version of Principia, is available, with performance improvements and some minor UI bug fixes.  Download it [here for 1.3.1](https://bit.ly/2ONYnEM), and [here for 1.4.x, 1.5.1 and 1.6.1](https://bit.ly/2uOzbVb).**
...
Download the binary (Ubuntu, macOS, and Windows) [here for 1.3.1](https://bit.ly/2ONYnEM), and [here for 1.4.x, 1.5.1 and 1.6.1](https://bit.ly/2uOzbVb).  Download the [“Trappist-1 for Principia”](https://github.com/mockingbirdnest/Principia/wiki/Installing,-reporting-bugs,-and-frequently-asked-questions#installing-trappist-1-for-principia) mini-mod [here](https://bit.ly/2RrjjkC).  Or, if you don't trust our binary, [build the mod](https://github.com/mockingbirdnest/Principia/blob/master/documentation/Setup.md) from the [Fano](https://github.com/mockingbirdnest/Principia/releases/tag/2019040509-Fano) release.
