...
**[Ἱππίας](https://github.com/mockingbirdnest/Principia/wiki/Change-Log#%E1%BC%B1%CF%80%CF%80%CE%AF%CE%B1%CF%82), the October version of Principia, is available with improvements.  Download it [here for 1.8.1, 1.9.1, 1.10.1, 1.11.0, 1.11.1, 1.11.2, 1.12.2, and 1.12.3](https://bit.ly/3TANxma).**

**For the convenience of Chinese users, download from 腾讯微云: [Principia Ἱππίας for 1.8.1—1.12.3](https://share.weiyun.com/CdtbITHd).**
...
Download the binary (Ubuntu, macOS, and Windows) [here for 1.8.1, 1.9.1, 1.10.1, 1.11.0, 1.11.1, 1.11.2, 1.12.2, and 1.12.3](https://bit.ly/3TANxma).  Or, if you don't trust our binary, [build the mod](https://github.com/mockingbirdnest/Principia/blob/master/documentation/Setup.md) from the [Ἱππίας](https://github.com/mockingbirdnest/Principia/releases/tag/2022102511-Ἱππίας) release.
