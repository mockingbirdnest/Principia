...
**[Διόφαντος](https://github.com/mockingbirdnest/Principia/wiki/Change-Log#%CE%94%CE%B9%CF%8C%CF%86%CE%B1%CE%BD%CF%84%CE%BF%CF%82), the October version of Principia, is available.  Download it [here for 1.3.1](https://goo.gl/8mfBZZ), and [here for 1.4.5](https://goo.gl/t9dUwX).**
...
Download the binary (Ubuntu, macOS, and Windows) [here for 1.3.1](https://goo.gl/8mfBZZ), and [here for 1.4.5](https://goo.gl/t9dUwX).  Download the [“Trappist-1 for Principia”](https://github.com/mockingbirdnest/Principia/wiki/Installing,-reporting-bugs,-and-frequently-asked-questions#installing-trappist-1-for-principia) mini-mod [here](https://goo.gl/pGVfXz).  Or, if you don't trust our binary, build the mod from the [Διόφαντος](https://github.com/mockingbirdnest/Principia/releases/tag/2018100904-%CE%94%CE%B9%CF%8C%CF%86%CE%B1%CE%BD%CF%84%CE%BF%CF%82) release.
