...
**&lrm;[Jensen](https://github.com/mockingbirdnest/Principia/wiki/Change-Log#jensen), the September version of Principia, is available.  Download it [here for 1.8.1, 1.9.1, 1.10.1, 1.11.0, 1.11.1, 1.11.2, and 1.12.2 to 1.12.5](https://bit.ly/3sQEaq1).**

**For the convenience of Chinese users, download from 腾讯微云: [Principia Jacobi for 1.8.1—1.12.5](https://share.weiyun.com/o1nLRAhs).**
...
Download the binary (Ubuntu, macOS, and Windows) [here for 1.8.1, 1.9.1, 1.10.1, 1.11.0, 1.11.1, 1.11.2, and 1.12.2 to 1.12.5](https://bit.ly/3sQEaq1).  Or, if you don't trust our binary, [build the mod](https://github.com/mockingbirdnest/Principia/blob/master/documentation/Setup.md) from the [Jensen](https://github.com/mockingbirdnest/Principia/releases/tag/2023091502-Jensen) release.
