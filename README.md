...
**&lrm;[von Koch](https://github.com/mockingbirdnest/Principia/wiki/Change-Log#von-koch), the September version of Principia, is available with numerous quality-of-life improvements.  Download it [here for 1.8.1, 1.9.1, 1.10.1, 1.11.0, 1.11.1, 1.11.2, and 1.12.2 to 1.12.5](https://bit.ly/v0nk0ch).**

**For the convenience of Chinese users, download from 腾讯微云: [Principia von Koch for 1.8.1—1.12.5](https://share.weiyun.com/bQERn9nz).**
...
Download the binary (Ubuntu, macOS, and Windows) [here for 1.8.1, 1.9.1, 1.10.1, 1.11.0, 1.11.1, 1.11.2, and 1.12.2 to 1.12.5](https://bit.ly/v0nk0ch).  Or, if you don't trust our binary, [build the mod](https://github.com/mockingbirdnest/Principia/blob/master/documentation/Setup.md) from the [von Koch](https://github.com/mockingbirdnest/Principia/releases/tag/2024090302-von%C2%A0Koch) release.
