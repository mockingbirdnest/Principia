...
**&lrm;[‎Lánczos](https://github.com/mockingbirdnest/Principia/wiki/Change-Log#l%C3%A1nczos), the September version of Principia, is available.  Download it [here for 1.8.1, 1.9.1, 1.10.1, 1.11.0, 1.11.1, 1.11.2, and 1.12.2 to 1.12.5](https://bit.ly/lancz0s).**

**For the convenience of Chinese users, download from 腾讯微云: [Principia Lánczos for 1.8.1—1.12.5](https://share.weiyun.com/zzCsJVlX).**
...
Download the binary (Ubuntu, macOS, and Windows) [here for 1.8.1, 1.9.1, 1.10.1, 1.11.0, 1.11.1, 1.11.2, and 1.12.2 to 1.12.5](https://bit.ly/lancz0s).  Or, if you don't trust our binary, [build the mod](https://github.com/mockingbirdnest/Principia/blob/master/documentation/Setup.md) from the [Lánczos](https://github.com/mockingbirdnest/Principia/releases/tag/2025092120-L%C3%A1nczos) release.
