...
**&lrm;[Leray](https://github.com/mockingbirdnest/Principia/wiki/Change-Log#leray), the July version of Principia, is available, with bug fixes.  Download it [here for 1.8.1, 1.9.1, 1.10.1, 1.11.0, 1.11.1, 1.11.2, and 1.12.2 to 1.12.5](https://bit.ly/ler4y).**

**For the convenience of Chinese users, download from 腾讯微云: [Principia Leray for 1.8.1—1.12.5](https://share.weiyun.com/OVEVXDhU).**
...
Download the binary (Ubuntu, macOS, and Windows) [here for 1.8.1, 1.9.1, 1.10.1, 1.11.0, 1.11.1, 1.11.2, and 1.12.2 to 1.12.5](https://bit.ly/ler4y).  Or, if you don't trust our binary, [build the mod](https://github.com/mockingbirdnest/Principia/blob/master/documentation/Setup.md) from the [Leray](https://github.com/mockingbirdnest/Principia/releases/tag/2026071410-Leray) release.
