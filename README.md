...
**Darboux, the May version of Principia, is available.  It has performance improvements and supports 1.4.3.  Download it [here for 1.3.1](https://goo.gl/tg1Zbr), and [here for 1.4.3](https://goo.gl/Sz2aBz).**	
...
Download the binary (Ubuntu, macOS, and Windows) [here for 1.3.1](https://goo.gl/tg1Zbr), and [here for 1.4.3](https://goo.gl/Sz2aBz).  Or, if you don't trust our binary, build the mod from the [Darboux](https://github.com/mockingbirdnest/Principia/releases/tag/2018051512-Darboux) release.
