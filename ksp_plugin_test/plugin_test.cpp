...
TEST_F(PluginTestWithoutPlugin, Serialization) {
  ...
  EXPECT_EQ(2, vessel_0_history.segment(0).zfp().timeline_size());
  EXPECT_EQ(2, vessel_0_history.segment(0).exact_size());
  EXPECT_EQ(
      5400,
  ...
  EXPECT_EQ(1, vessel_0_history.segment(2).exact_size());
  EXPECT_EQ(
      5461,
