...
// accepted for use with the SI.  See Résolution B3 "Sur les valeurs
// recommandées de constantes de conversion pour une sélection de propriétés
// solaires et planétaires" adopted at the XXIX General Assembly of the IAU in
// 2015.
namespace astronomy {
