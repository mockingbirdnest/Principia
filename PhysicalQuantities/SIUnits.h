...
Length            const Metre     = Metres(1);
Mass              const Kilogram  = Kilograms(1);
Time              const Second    = Seconds(1);
Current           const Ampere    = Amperes(1);
Temperature       const Kelvin    = Kelvins(1);
Amount            const Mole      = Moles(1);
LuminousIntensity const Candela   = Candelas(1);
// Nonstandard.
Winding           const Cycle     = Cycles(1);
...
Dimensionless π = 3.14159265358979323846264338327950288419716939937511;
