...
template<typename Position>
SymplecticRungeKuttaNyströmIntegrator<Position, , , > const& BlanesMoan2002SRKN6B() {
  static SymplecticRungeKuttaNyströmIntegrator<
             Position, , , > const integrator({ 0.24529895718427100,
                                           0.60487266571108000,
                                          -0.35017162289535100,
                                          -0.35017162289535100,
                                           0.60487266571108000,
...
template<typename Position>
SymplecticRungeKuttaNyströmIntegrator<Position, , , > const&
 McLachlanAtela1992Order5Optimal() {
  static SymplecticRungeKuttaNyströmIntegrator<
             Position, , , > const integrator({ 0.339839625839110000,
...
SymplecticRungeKuttaNyströmIntegrator<Position, , , > const&
 OkunborSkeel1994Order6Method13() {
  static SymplecticRungeKuttaNyströmIntegrator<
             Position, , , > const integrator({-1.0130879789171747298,
...
SymplecticRungeKuttaNyströmIntegrator<Position, , , > const&
 BlanesMoan2002SRKN11B() {
  static SymplecticRungeKuttaNyströmIntegrator<
             Position, , , > const integrator({ 0.12322977594627100,
                                           0.29055379779955800,
                                          -0.12704921262541700,
                                          -0.24633176106207500,
                                           0.35720887279592800,
...
SymplecticRungeKuttaNyströmIntegrator<Position, , , > const&
 BlanesMoan2002SRKN14A() {
  static SymplecticRungeKuttaNyströmIntegrator<
             Position, , , > const integrator({ 0.037859319840611600,
                                           0.10263563310243500,
