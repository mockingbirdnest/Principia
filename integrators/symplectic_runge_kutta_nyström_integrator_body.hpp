...
SymplecticRungeKuttaNyströmIntegrator<Position, 4, 4, kBA> const&
McLachlanAtela1992Order4Optimal() {
static SymplecticRungeKuttaNyströmIntegrator<
           Position, 4, 4, kBA> const integrator({ 0.5153528374311229364,
...
template<typename Position>
SymplecticRungeKuttaNyströmIntegrator<Position, 4, 4, kABA> const&
McLachlan1995SB3A4() {
  static SymplecticRungeKuttaNyströmIntegrator<
             Position, 4, 4, kABA> const integrator({ 0.18819521776883821787,
...
template<typename Position>
SymplecticRungeKuttaNyströmIntegrator<Position, 4, 5, kABA> const&
McLachlan1995SB3A5() {
  static SymplecticRungeKuttaNyströmIntegrator<
             Position, 4, 5, kABA> const integrator({ 0.4051886183952522772,
...
template<typename Position>
SymplecticRungeKuttaNyströmIntegrator<Position, 4, 6, kBAB> const&
BlanesMoan2002SRKN6B() {
  static SymplecticRungeKuttaNyströmIntegrator<
             Position, 4, 6, kBAB> const integrator({ 0.24529895718427100,
                                                      0.60487266571108000,
                                                     -0.35017162289535100,
                                                     -0.35017162289535100,
                                                      0.60487266571108000,
...
template<typename Position>
SymplecticRungeKuttaNyströmIntegrator<Position, 5, 6, kBA> const&
 McLachlanAtela1992Order5Optimal() {
  static SymplecticRungeKuttaNyströmIntegrator<
             Position, 5, 6, kBA> const integrator({ 0.339839625839110000,
...
template<typename Position>
SymplecticRungeKuttaNyströmIntegrator<Position, 6, 7, kABA> const&
 OkunborSkeel1994Order6Method13() {
  static SymplecticRungeKuttaNyströmIntegrator<
             Position, 6, 7, kABA> const integrator({-1.0130879789171747298,
...
template<typename Position>
SymplecticRungeKuttaNyströmIntegrator<Position, 6, 11, kBAB> const&
 BlanesMoan2002SRKN11B() {
  static SymplecticRungeKuttaNyströmIntegrator<
             Position, 6, 11, kBAB> const integrator({ 0.12322977594627100,
                                                       0.29055379779955800,
                                                      -0.12704921262541700,
                                                      -0.24633176106207500,
                                                       0.35720887279592800,
...
template<typename Position>
SymplecticRungeKuttaNyströmIntegrator<Position, 6, 14, kABA> const&
 BlanesMoan2002SRKN14A() {
  static SymplecticRungeKuttaNyströmIntegrator<
             Position, 6, 14, kABA> const integrator({ 0.037859319840611600,
                                                       0.10263563310243500,
