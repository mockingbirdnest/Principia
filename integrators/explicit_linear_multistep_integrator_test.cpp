...
TEST_P(ExplicitLinearMultistepIntegratorTest, Symplecticity) {
  LOG(INFO) << GetParam();
...
TEST_P(ExplicitLinearMultistepIntegratorTest, Termination) {
  LOG(INFO) << GetParam();
  Length const q_initial = 1 * Metre;
  Speed const v_initial = 0 * Metre / Second;
  Instant const t_initial;
...
TEST_P(ExplicitLinearMultistepIntegratorTest, LongIntegration) {
  LOG(INFO) << GetParam();
  Length const q_initial = 1 * Metre;
  Speed const v_initial = 0 * Metre / Second;
  Speed const v_amplitude = 1 * Metre / Second;
...
TEST_P(ExplicitLinearMultistepIntegratorTest, Serialization) {
  LOG(INFO) << GetParam();
  Length const q_initial = 1 * Metre;
  Speed const v_initial = 0 * Metre / Second;
  Instant const t_initial;
