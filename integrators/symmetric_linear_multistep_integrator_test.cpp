...
std::vector<SimpleHarmonicMotionTestInstance> Instances() {
  return {INSTANCE(Quinlan1999Order8A,
                   0.5 * Second,
                   2.31287211605035736e-11 * Metre,
                   4.63121763161211675e-11 * Metre / Second,
                   1.33057252604817933e-07 * Joule),
          INSTANCE(Quinlan1999Order8B,
                   0.3 * Second,
                   2.35983454999200148e-12 * Metre,
                   3.33955085807247087e-12 * Metre / Second,
                   1.64380670186758948e-07 * Joule),
          INSTANCE(QuinlanTremaine1990Order8,
                   0.5 * Second,
                   1.84990356366654396e-11 * Metre,
                   2.50033882487343817e-11 * Metre / Second,
                   1.43651021133894830e-07 * Joule),
          INSTANCE(QuinlanTremaine1990Order10,
                   0.4 * Second,
                   1.96220817372250167e-12 * Metre,
                   2.99391067493104401e-12 * Metre / Second,
                   4.11567468994178398e-09 * Joule),
          INSTANCE(QuinlanTremaine1990Order12,
                   0.2 * Second,
                   7.67830243830758263e-12 * Metre,
                   1.22954979531186837e-11 * Metre / Second,
                   8.86367645946961602e-11 * Joule)};
}
