...
std::vector<SimpleHarmonicMotionTestInstance> Instances() {
  return {INSTANCE(Quinlan1999Order8A,
                   0.5 * Second,
                   9.98714999589367380e-14 * Metre,
                   1.00162933502900842e-13 * Metre / Second,
                   1.33057256879176578e-07 * Joule),
          INSTANCE(Quinlan1999Order8B,
                   0.3 * Second,
                   9.97951721259937585e-14 * Metre,
                   9.99027249815043206e-14 * Metre / Second,
                   1.64380668188357504e-07 * Joule),
          INSTANCE(QuinlanTremaine1990Order8,
                   0.5 * Second,
                   9.97535387625703152e-14 * Metre,
                   9.98992555345523670e-14 * Metre / Second,
                   1.43651014083978623e-07 * Joule),
          INSTANCE(QuinlanTremaine1990Order10,
                   0.4 * Second,
                   9.97465998686664079e-14 * Metre,
                   9.99131333223601814e-14 * Metre / Second,
                   4.11567491198638891e-09 * Joule),
          INSTANCE(QuinlanTremaine1990Order12,
                   0.2 * Second,
                   9.93788384917593248e-14 * Metre,
                   9.95453719454530983e-14 * Metre / Second,
                   8.86300477453971780e-11 * Joule)};
}
