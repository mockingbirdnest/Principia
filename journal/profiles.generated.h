...
struct SetAngularMomentumConservation : not_constructible {
  struct In final {
    bool const conserve_angular_momentum;
  };

  using Message = serialization::SetAngularMomentumConservation;
...
struct VesselGetPileUpTrace : not_constructible {
  struct In final {
  ...
  using Message = serialization::VesselGetPileUpTrace;
  static void Fill(In const& in, not_null<Message*> const message);
...
struct PlanetariumPlotCelestialTrajectoryForPsychohistory : not_constructible {
  struct In final {
    Planetarium const* const planetarium;
    Plugin const* const plugin;
    int const celestial_index;
  ...
  using Message = serialization::PlanetariumPlotCelestialTrajectoryForPsychohistory;
  static void Fill(In const& in, not_null<Message*> const message);
  static void Fill(Return const& result, not_null<Message*> const message);
  static void Run(Message const& message,
                  Player::PointerMap& pointer_map);
...
struct PlanetariumPlotCelestialTrajectoryForPredictionOrFlightPlan : not_constructible {
  struct In final {
    Planetarium const* const planetarium;
    Plugin const* const plugin;
    int const celestial_index;
  ...
  using Message = serialization::PlanetariumPlotCelestialTrajectoryForPredictionOrFlightPlan;
  static void Fill(In const& in, not_null<Message*> const message);
  static void Fill(Return const& result, not_null<Message*> const message);
  static void Run(Message const& message,
                  Player::PointerMap& pointer_map);
...
struct VesselRefreshAnalysis : not_constructible {
  struct In final {
    Plugin const* const plugin;
    char const* const vessel_guid;
