...
struct CollisionDeleteExecutor : not_constructible {
  struct In final {
    Plugin const* const plugin;
    PushPullExecutor<std::optional<DistinguishedPoints<World>::value_type>, Length, Angle, Angle>** const executor;
  };
  struct Out final {
    PushPullExecutor<std::optional<DistinguishedPoints<World>::value_type>, Length, Angle, Angle>** const executor;
    TQP* const collision;
...
struct CollisionNewFlightPlanExecutor : not_constructible {
  ...
  using Return = PushPullExecutor<std::optional<DistinguishedPoints<World>::value_type>, Length, Angle, Angle>*;
...
struct GraphLidovFrozenLine : not_constructible {
  struct In final {
    double const c2;
  };
  using Return = double;

  using Message = serialization::GraphLidovFrozenLine;
  static void Fill(In const& in, not_null<Message*> const message);
  static void Fill(Return const& result, not_null<Message*> const message);
  static void Run(Message const& message,
                  Player::PointerMap& pointer_map);
...
struct GraphLidovMaximalEccentricityLine : not_constructible {
  struct In final {
  ...
  using Message = serialization::GraphLidovMaximalEccentricityLine;
  static void Fill(In const& in, not_null<Message*> const message);
  static void Fill(Return const& result, not_null<Message*> const message);
  static void Run(Message const& message,
                  Player::PointerMap& pointer_map);
...
struct GraphLidovMaximalEccentricityLineC2Range : not_constructible {
  struct In final {
    double const eccentricity;
  };
  using Return = Interval;

  using Message = serialization::GraphLidovMaximalEccentricityLineC2Range;
  static void Fill(In const& in, not_null<Message*> const message);
  static void Fill(Return const& result, not_null<Message*> const message);
  static void Run(Message const& message,
                  Player::PointerMap& pointer_map);
...
struct GraphLidovMaximalInclinationLine : not_constructible {
  struct In final {
  ...
  using Message = serialization::GraphLidovMaximalInclinationLine;
  static void Fill(In const& in, not_null<Message*> const message);
  static void Fill(Return const& result, not_null<Message*> const message);
  static void Run(Message const& message,
                  Player::PointerMap& pointer_map);
...
struct GraphLidovMaximalInclinationLineC2Range : not_constructible {
  struct In final {
    double const inclination_in_degrees;
  };
  using Return = Interval;

  using Message = serialization::GraphLidovMaximalInclinationLineC2Range;
  static void Fill(In const& in, not_null<Message*> const message);
  static void Fill(Return const& result, not_null<Message*> const message);
  static void Run(Message const& message,
                  Player::PointerMap& pointer_map);
...
struct GraphLidovMinimalEccentricityLeftLine : not_constructible {
  struct In final {
    double const eccentricity;
    double const c2;
  };
  ...
  using Message = serialization::GraphLidovMinimalEccentricityLeftLine;
  static void Fill(In const& in, not_null<Message*> const message);
  static void Fill(Return const& result, not_null<Message*> const message);
  static void Run(Message const& message,
                  Player::PointerMap& pointer_map);
...
struct GraphLidovMinimalEccentricityLeftLineC2Range : not_constructible {
  struct In final {
    double const eccentricity;
  };
  using Return = Interval;

  using Message = serialization::GraphLidovMinimalEccentricityLeftLineC2Range;
  static void Fill(In const& in, not_null<Message*> const message);
  static void Fill(Return const& result, not_null<Message*> const message);
  static void Run(Message const& message,
                  Player::PointerMap& pointer_map);
...
struct GraphLidovMinimalEccentricityRightLineC2AndC1Max : not_constructible {
  struct In final {
    double const eccentricity;
  };
  struct Out final {
  ...
  using Message = serialization::GraphLidovMinimalEccentricityRightLineC2AndC1Max;
  static void Fill(In const& in, not_null<Message*> const message);
  static void Fill(Out const& out, not_null<Message*> const message);
  static void Run(Message const& message,
                  Player::PointerMap& pointer_map);
...
struct GraphLidovMinimalInclinationLine : not_constructible {
  struct In final {
    double const inclination_in_degrees;
    double const c2;
  };
  ...
  using Message = serialization::GraphLidovMinimalInclinationLine;
  static void Fill(In const& in, not_null<Message*> const message);
  static void Fill(Return const& result, not_null<Message*> const message);
  static void Run(Message const& message,
                  Player::PointerMap& pointer_map);
...
struct GraphLidovMinimalInclinationLineC2Range : not_constructible {
  struct In final {
    double const inclination_in_degrees;
  };
  using Return = Interval;

  using Message = serialization::GraphLidovMinimalInclinationLineC2Range;
  static void Fill(In const& in, not_null<Message*> const message);
  static void Fill(Return const& result, not_null<Message*> const message);
  static void Run(Message const& message,
                  Player::PointerMap& pointer_map);
...
struct IteratorGetDistinguishedPointsQP : not_constructible {
  struct In final {
    Iterator const* const iterator;
  };
  using Return = QP;

  using Message = serialization::IteratorGetDistinguishedPointsQP;
  static void Fill(In const& in, not_null<Message*> const message);
  static void Fill(Return const& result, not_null<Message*> const message);
  static void Run(Message const& message,
                  Player::PointerMap& pointer_map);
...
struct IteratorGetDistinguishedPointsTime : not_constructible {
  struct In final {
    Iterator const* const iterator;
  };
  using Return = double;

  using Message = serialization::IteratorGetDistinguishedPointsTime;
  static void Fill(In const& in, not_null<Message*> const message);
  static void Fill(Return const& result, not_null<Message*> const message);
  static void Run(Message const& message,
                  Player::PointerMap& pointer_map);
...
struct IteratorGetPlottableElements : not_constructible {
  struct In final {
    Iterator const* const iterator;
  };
  using Return = PlottableElements;

  using Message = serialization::IteratorGetPlottableElements;
  static void Fill(In const& in, not_null<Message*> const message);
  static void Fill(Return const& result, not_null<Message*> const message);
  static void Run(Message const& message,
                  Player::PointerMap& pointer_map);
...
struct PartAngularMomentumFromAngularVelocity : not_constructible {
  struct In final {
  ...
  using Message = serialization::PartAngularMomentumFromAngularVelocity;
  static void Fill(In const& in, not_null<Message*> const message);
  static void Fill(Return const& result, not_null<Message*> const message);
  static void Run(Message const& message,
                  Player::PointerMap& pointer_map);
...
struct PartDragTorqueFromAngularVelocity : not_constructible {
  struct In final {
  ...
  using Message = serialization::PartDragTorqueFromAngularVelocity;
  static void Fill(In const& in, not_null<Message*> const message);
  static void Fill(Return const& result, not_null<Message*> const message);
  static void Run(Message const& message,
                  Player::PointerMap& pointer_map);
...
struct PluginReaderAwait : not_constructible {
  struct In final {
  ...
  using Message = serialization::PluginReaderAwait;
  static void Fill(In const& in, not_null<Message*> const message);
  static void Fill(Out const& out, not_null<Message*> const message);
  static void Fill(Return const& result, not_null<Message*> const message);
  static void Run(Message const& message,
...
struct PluginReaderGet : not_constructible {
  struct In final {
    PluginReader** const reader;
  };
  struct Out final {
  ...
  using Message = serialization::PluginReaderGet;
  static void Fill(In const& in, not_null<Message*> const message);
  static void Fill(Out const& out, not_null<Message*> const message);
  static void Fill(Return const& result, not_null<Message*> const message);
  static void Run(Message const& message,
...
struct PluginReaderLogs : not_constructible {
  struct In final {
    PluginReader* const reader;
  };
  using Return = char const*;

  using Message = serialization::PluginReaderLogs;
  static void Fill(In const& in, not_null<Message*> const message);
  static void Fill(Return const& result, not_null<Message*> const message);
  static void Run(Message const& message,
                  Player::PointerMap& pointer_map);
...
struct PluginReaderWillBeSlow : not_constructible {
  struct In final {
    PluginReader const* const reader;
  };
  using Return = bool;

  using Message = serialization::PluginReaderWillBeSlow;
  static void Fill(In const& in, not_null<Message*> const message);
  static void Fill(Return const& result, not_null<Message*> const message);
  static void Run(Message const& message,
                  Player::PointerMap& pointer_map);
