...
\gs &= -\frac{\scal{\bipoint KA}{\bipoint KH} \scal{\bipoint AB}{\bipoint KH}}
\]
...
\gt = \frac{{\scal{\bipoint KH}{\bipoint KH} - \scal{\bipoint PH}{\bipoint KH} - \scal{\bipoint KA}{\bipoint KH}} \scal{\bipoint AB}{\bipoint KH}}
\]
...
that $\point A$ and $\point B$ are in the same order as $\point S$ and $\point T$
on $\straightline AB$.  Then we have $\gs <= \gt$ and the intersection is farther
than $\point T$ (as seen from the camera) if and only if $\gt < \gl$.  Conversely, if $\point A$ and
$\point B$ are in the reverse order as $\point S$ and $\point T$ on
$\straightline AB$ we have $\gt <= \gs$ and intersection is farther
than $\point T$ if and only if $\gl < \gt$
