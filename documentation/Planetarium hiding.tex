...
\marginfig[Definition2 of $\point S$ and $\point T$.\label{figST}]{
\begin{tikzpicture}[scale=0.5]
...
\tkzDefPoint(0,0){H}
\tkzDefPoint(0,6){K}
\tkzDefPoint(2.598,1.5){P}
\tkzDefPoint(-2.598,1.5){P2}
\tkzDefPoint(3.666,6){S}
\tkzDefPoint(5.166,1.5){T}

\tkzDrawPoints(A,B,C,H,K,P,S,T)
\tkzLabelPoints(A,B,C,H,K,P,S,T)
