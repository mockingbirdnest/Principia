...
a cube root is no longer prohibitive.
...
Note that this formula is valid for $M\leq\smash{\frac{\Pi}{2}}$;
the corresponding expressions for $\frac{\Pi}{2}\leq M\leq\frac{3\Pi}{2}$ and for
some of the $M>\frac{3\Pi}{2}$ are \emph{casus irreducibiles}\footnote{See \cite[469]{FantetdeLagny1697} for a definition
of the \emph{cas irreductible} of a cubic; see \cite[125\psqq]{Wantzel1843} for a proof of its irreducibility.}, and thus are less
practically useful; it is probably best to use one of the formulæ above for the middle, and to get rid of the upper half by argument
reduction.
\begin{center}
\begin{tabular}{lrrrr}
Approximation of $E$ & Max.~error for $e=0.2$ & $e=0.5$ & $e=0.9$ & $e=0.999$ \\
