...
Member of the \foreign{\textfrench{Académie Royale des Sciences}}. See \cite{Fontenelle1734}, reprinted in \volcite{6}[557]{Fontenelle1758}.}. Lagny's methods
...
choice of starting estimate $α=M$, whose starting error is asymptotically linear in $e$, and linear
in $M$ near $M=0$ (periapsis) and $M=\Pi$ (apoapsis).
...
\end{tabular}
\end{center}
For $α=M$, we have the following simplified formulæ; the asymptotic errors near $M=\Pi$ are the same up to sign.
\begin{center}
\begin{tabular}{lr}
Formula & Asymptotic error near $M=0$\\
\hline
$M+\frac{es}{1-ec}$ & $\tfrac{1}{2}e^3M^3+\BigO\of{e^3M^5+e^4M^3}$\\
$M+\frac{2\pa{1-ec}es}{2-4ec+e^2c^2+e^2}$ & $\tfrac{1}{6}e^4M^3+\BigO\of{e^4M^5+e^5M^3}$\\
$M+\frac{3es\pa{2-4ec+e^2c^2+e^2}}{6\pa{1+2e^2c^2-e^3c^3+e^2}-e\pa{18+5e^2s^2}c}$ & $-\tfrac{1}{24}e^5M^5+\BigO\of{e^5M^7+e^6M^5}$\\
\end{tabular}
\end{center}
\subsubsection{Quadratic irrational methods}
...
\end{tabular}
\end{center}
For $α=M$, we have the following simplified formulæ; again the asymptotic errors near apoapsis are the same up to sign.
\begin{center}
\begin{tabular}{lrr}
Formula & Asymptotic error near $M=0$\\
\hline
$M+\frac{ec-1+\sqrt{\pa{1-ec}^2+2e^2s^2}}{es}$ & $\tfrac{1}{6}e^4M^3+\BigO\of{e^4M^5+e^5M^3}$\\
$M+\frac{2esc-3s\pm\sqrt{\pa{3-4ec}^2s^2+18e^2s^4}}{2c\pa{ec-1}+3es^2}$  & $-\tfrac{1}{18}e^5M^3+\BigO\of{e^5M^5+e^6M^3}$\\
\end{tabular}
\end{center}
