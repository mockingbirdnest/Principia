...
see the discussion in appendix~\ref{Performance}.} it as, \exempligratia,\begin{equation}
ξ' = \pa{\sqrt{3}{q'}^2+\sqrt{4yq'-{q'}^4}}\frac{1/\sqrt{12}}{q'}\text,\label{RewrittenLagnyIrrational}
\end{equation}
...
The constants become TODO(egg): compute those.
...
misrounding'' path is $2.6479(52)\Multiply 10^{-04}$; the latency of that slow path is less than ten times that of the fast path,
...
\hline
Fullerton, 1977& $\dagger$  & $2.60500(14)\Multiply10^{-01}$ \\
Moshier, 1984&              & $8.55740(89)\Multiply10^{-02}$ \\
Kahan, 1991 & $Γ=-1$        & $2.0044(15)\Multiply10^{-03}$  \\
\emph{ibid.}& $Γ=-1$ $\mathrm{N}$     & $9.6466(99)\Multiply10^{-04}$  \\
\emph{ibid.}& $Γ=-35/3$     & $1.7236(42)\Multiply10^{-04}$  \\
\emph{ibid.}& $Γ=-35/3$ $\mathrm{N}$  & $8.367(29)\Multiply10^{-05}$   \\
Plauger, 1992& $\dagger$    & $3.02720(15)\Multiply10^{-01}$ \\
Sun,     1993&              & $8.31642(88)\Multiply10^{-02}$ \\
Drepper, 1997& $\dagger$    & $4.96271(16)\Multiply10^{-01}$ \\
Sun--Evans, 2005&           & $8.33311(88)\Multiply10^{-02}$ \\
Maddock, 2006& $\dagger$    & $4.56285(16)\Multiply10^{-01}$ \\
Canon--Kidder, 2008&        & $8.02588(86)\Multiply10^{-02}$ \\
AMD, 2014& $*$              & $1.6235(41)\Multiply10^{-04}$ \\
njuffa, 2014& $*$           & $1.529(40)\Multiply10^{-06}$ \\
Leroy, 2018 & $3^16^1$                        & $5.155(72)\Multiply10^{-06}$ \\
Leroy, 2021 & $3^2_{\mathrm{C}}5^1$           & $4.575(68)\Multiply10^{-06}$ \\
\emph{ibid.}& $3^2_{\mathrm{C}}6^1$           & $4.357(67)\Multiply10^{-06}$ \\
\emph{ibid.}& $3^2_{\mathrm{C}}\mathrm{N}6^1$ & $2.417(50)\Multiply10^{-06}$ \\
\emph{ibid.}& $5^24^1*$                       & $6.10(25)\Multiply10^{-09}$ \\
\emph{ibid.}& $5^2\mathrm{N}6^1*$             & $2.99(18)\Multiply10^{-09}$
\end{tabular}
\caption{Misrounding rates of various methods for the computation of a binary64 cube root.
An asterisk marks methods that use FMA; a dagger marks unfaithful methods.}
\end{table}
\begin{figure}[htb]
...
An asterisk marks methods that use FMA; a dagger marks unfaithful methods.\label{TableMisroundingRates}}
\end{adjustwidth}
\end{figure}
\vfill
\pagebreak
