...
The implementation choices that involve performance considerations are resolved in appendix~\ref{Performance}; an
...
\item Sun Microsystems, Inc.'s 1993 function \cbstart{}\texttt{cbrt}\cbend{} from the Freely Distributable LIBM;
...
The letters $\mathrm{FMA}$ mark methods that use FMA; an obelisk marks unfaithful methods.\label{TableMisroundingRates}}
\end{table}
