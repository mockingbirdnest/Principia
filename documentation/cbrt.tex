...
$a\frac{-5b+\sqrt{3\pa{108a^6+108a^3b-5b^2}}}{18a^2-2b}$ & $-\tfrac{1}{18}ε^5+\BigO\of{ε^6}$ \\
\end{tabular}
\end{center}
...
further.
Both the rational and irrational methods of order $5$ have errors below $2^{-28}$; little stands to be gained
...
\label{Performance}
We obviously consider the latency of the cube root function. Its reciprocal throughput is however a somewhat artificial
quantity, as workloads consisting solely of cube roots are rare. We thus also consider the variation in throughput of
the cubic formula for Kepler's problem, given in appendix~\ref{ExampleGeneralizedLagnyMethods}, as a more plausible workload.
In this context the irrational methods tend to be superior, as they put more of their work on the otherwise less-used
division unit.
...
\]
The irrational method of the same order may be evaluated with similar performance on Skylake if it is rewritten as\[
