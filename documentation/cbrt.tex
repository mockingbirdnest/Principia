...
methods, so can a \emph{casus irreducibilis}; indeed Lagny gives some formulæ for that (of order $3$ and degree $1$ and $2$) in
\cite[41]{FantetdeLagny1692}. For convenience, it may be useful to implement the function
