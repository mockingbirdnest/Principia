...
\maketitle
\noindent
This document describes the implementation of the function {\texttt{principia::\hspace{0pt}numerics::\hspace{0pt}Cbrt}},
in \href{https://github.com/mockingbirdnest/Principia/blob/master/numerics/cbrt.cpp}{\texttt{numerics/cbrt.cpp}}.
...
the first of which is about a family of root-finding methods for arbitrary functions, wherein all methods here
