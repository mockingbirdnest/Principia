...
\item $\roundTowardZero{α}$ for the nearest representable number with smaller in magnitude than $α$: rounding-direction attribute roundTowardZero.
\end{itemize}
...
\marginfig[Error of $ξ'$ for various methods.\label{figStepTwoComparison}]{\rlap{\includegraphics[scale=0.7]{cbrt_ξ_error.pdf}}}
\begin{align*}
