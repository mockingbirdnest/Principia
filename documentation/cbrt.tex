...
\end{align*}
\marginnote{TODO(egg): Play the game of the {\xsuxfont 𒋛𒄥𒊏𒋾}; we can shave off approximately
$\tfrac{2}{3}u$ on $Δ_1$ (and a small amount on the denominator of $Δ_2$).}
...
\[τ=\hex{1.E45E16EF5480F}\Multiply 2^{-76}\text,\]
...
Kahan, 1991 & $\mathrm{Γ}=-1$        & $2.0044(15)\Multiply10^{-03}$  \\
\emph{ibid.}& $\mathrm{Γ}=-1$ $\mathrm{N}$     & $9.6466(99)\Multiply10^{-04}$  \\
\emph{ibid.}& $\mathrm{Γ}=-35/3$     & $1.7236(42)\Multiply10^{-04}$  \\
\emph{ibid.}& $\mathrm{Γ}=-35/3$ $\mathrm{N}$  & $8.367(29)\Multiply10^{-05}$   \\
...
\emph{ibid.}& $5^2\mathrm{N}4^1*$             & $2.99(18)\Multiply10^{-09}$
\end{tabular}
