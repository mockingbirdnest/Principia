...
\end{quote}
It appears that this honour belongs either to Lagrange, with a series in $\derivop[n] M {\sin^nM}$,
given in \cite[209]{Lagrange1771} and reprinted in \volcite{3}[117]{Lagrange1867},
or to Bessel, with a series in $\sin nM$ whose coefficients are given by his eponymous functions, given in an 1818 letter to
