...
\marginpar{\small TODO(egg): bound the rounding errors.}
...
a higher order iterate or Lagny's irrational formula. Also consider optimizing the constants per Canon's  tweet;
in the rational method there are none to optimize.
% 9 Jul 2018
