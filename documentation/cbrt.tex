...
The rounding step $\FunctionBody ξ x$ was surprisingly faster when performed using Veltkamp--Dekker than by directed rounding using \texttt{andpd} on Sandy Bridge, and about equally fast on Ivy Bridge. Given the increased precision, we thus round to nearest in that
step.
