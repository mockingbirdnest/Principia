...
Note that we do not consider the generalized Lagny irrational methods here, as their computation without FMA involves
ill-conditioned differences after inexact operations.
...
than $17$, but still cannot add more than $53$. Again the irrational methods are unlikely to be of much use in
this step, since we are already using the FMA to compute the cube of $x$, restricting its usage to avoid further
cancellation; a fused addition of two products would be needed for that.
