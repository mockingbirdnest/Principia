...
and the method of fifth order in step~\ref{HighOrder}, allowing for $100u$ on the computation of $ξ$; if instead
we round toward zero in step~\ref{RoundedApproximation}, we have\[
τ=\hex{1.7C8587D10158C}\Multiply 2^{-13}\text.
\]
