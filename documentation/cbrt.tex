...
Member of the \foreign{\textfrench{Académie Royale des Sciences}}. See \cite{Fontenelle1734}.}. Lagny's methods
...
For the method of order $4$, the sign $\pm$ should be positive when $M<\Pi$, and negative when $M>\Pi$; again the asymptotic errors
near apoapsis are the same up to sign.
\begin{center}
\begin{tabular}{l}
Iteration\\
\hline
