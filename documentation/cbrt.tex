...
\]
Note however that for the computation of the cube root, the phrase \emph{Lagny's irrational method} is unambiguous;
assuming that one does not wish to reduce the computation of a cube root to that of of the root the cubic $E_3$,
the only irrational method is the quadratic one (\ref{LagnyIrrationalCubeRootIteration}).
