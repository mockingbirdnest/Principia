...
\subsection*{Around Table Entries}
If $x \in \intclos{\pa{2 k - 1}\gD}{\pa{2 k + 1}\gD}$ we compute $h = x - x_k$.  It is essential that this subtraction be exact, and therefore that the conditions of Sterbenz's lemma be met: we must have $x / 2 \le x_k \le 2 x$.  Based on the range of $x$, a sufficient condition for this is:
\[
