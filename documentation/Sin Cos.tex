...
t_3 &\DefineAs \round{h \round{2 \; \gd \red x + h}} \\
t_4 &\DefineAs \roundAll{h^3} \\
t_5 &\DefineAs \roundAll{\round{s_k} \; t3 \; t2} \\
t_6 &\DefineAs \round{t4 \; t1} \\
t_7 &\DefineAs \round{\round{c_k} t6 + t5} \\
t_8 &\DefineAs \round{\round{c_k} \gd \red x + t_0 \; \gd_0} \\
t_9 &\DefineAs \round{t7 + t8} \\
...
t_3 &\DefineAs \round{h \round{2 \; \gd \red x + h}} \\
t_4 &\DefineAs \roundAll{h^3} \\
t_5 &\DefineAs \roundAll{\round{c_k} \; t3 \; t2} \\
t_6 &\DefineAs \round{t4 \; t1} \\
t_7 &\DefineAs \round{-\round{s_k} t6 + t5} \\
t_8 &\DefineAs \round{-\round{s_k} \gd \red x + t_0 \; \gd_0} \\
t_9 &\DefineAs \round{t7 + t8} \\
y &\DefineAs t_0 \pa{1 - \gd_0} \\
\gd y &\DefineAs t_9
\end{dcases}
...
\]
and a \textit{Mathematica} computation yields $\abs{r\of{\red x, \gd \red x}} < 2^{-69.217}$.  Again, the largest errors come from table entries that have many ones after their accurate zeroes (or many zeroes after their accurate ones).  The rounding test must be done with $e = \texttt{0x1.0001'B836'988A'Dp0}$.
