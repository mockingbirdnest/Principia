...
\ShowLn Compute $M' = \floor{\frac{1/2}{1/M + \ge}}$, $C = 3 M'$, and\footnote{The notation $\iround{C · P_i\of{T \gt}}$ means that we round to the nearest each coefficient of $C . P_i\of{T \gt}$.  This gives an element of $\Integers [ \gt ]$} $P^~_i\of{\gt} = \iround{C · P_i\of{T \gt}}$ for $i \in \set{1, 2}$.\;
\ShowLn Let $e_1 = 1$, $e_2 = \gt$, $e_3 = \gt^2$, $e_4 = \gu$, $e_5 = \gf$.\;
\ShowLn Let $g_1 = C$, $g_2 = C T · \gt$, $g_3 = P^~_1\of{\gt} + 3 \gu$, $g_4 = P^~_2\of{\gt} + 3 \gf$.\;
...
\caption{SimultaneousBadCaseSearch.}
\end{algorithm}
