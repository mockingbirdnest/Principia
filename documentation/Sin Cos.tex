...
t_2 &\DefineAs \roundAll{{\red x}^3} \\
t_3 &\DefineAs \round{t_1 t_2 + \gd \red x} \\
y &\DefineAs \red x \\
\gd y &\DefineAs t_3
\end{dcases}
\]
...
t_4 &\DefineAs \roundAll{h^3} \\
t_5 &\DefineAs \round{\round{\round{s_k} \; t_3} \; t_2} \\
t_6 &\DefineAs \round{t_4 \; t_1 + \gd \red x} \\
t_7 &\DefineAs \round{\round{c_k} t_6 + t_5} \\
t_8 &\DefineAs \round{t_7 + t_0 \; \gd_0} \\
...
t_6 &= \pa{t_4 \; t_1 + \gd \red x} \pa{1 + \gd_7} \\
t_7 &= \pa{\round{c_k} \; t_6 + t_5} \pa{1 + \gd_8} \\
t_8 &= \pa{t_7 + t_0 \; \gd_0} \pa{1 + \gd_9} \\
\end{alignedat}
\right.
\]
The relative error on the entire computation is:
...
t_6 &\DefineAs \round{t_4 \; t_1 + \gd \red x} \\
t_7 &\DefineAs \round{-\round{s_k} t_6 + t_5} \\
t_8 &\DefineAs \round{t_7 + t_0 \; \gd_0} \\
y &\DefineAs t_0 \pa{1 - \gd_0} \\
\gd y &\DefineAs t_8
\end{dcases}
...
\[
\gd_0 \; \gd_9 \; \pa{-\round{c_k} + h \round{s_k}}
\]
and a \textit{Mathematica} computation yields $\abs{r\of{\red x, \gd \red x}} < 2^{-69.217}$.  Again, the largest errors come from table entries that have many ones after their accurate zeroes (or many zeroes after their accurate ones).  The rounding test must be done with $e = \texttt{0x1.0001'B836'988A'Bp0}$.
