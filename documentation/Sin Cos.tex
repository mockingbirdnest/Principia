...
\end{dcases}
\]
where $LongSub$ is the obvious adaptation of the algorithm $LongAdd$ presented in section 5 of \cite{Linnainmaa1981}.  Note that $QuickTwoSum$ is usable for the computation of $\pa{z, \gd z}$ because clearly $\abs{\gd z} < \abs z$.
