...
\subsection*{Sin Near Zero}
If $\abs{x} \le 2^{-10}$ we have:\marginnote{TODO(phl): Align the notation in the notebook.}
\[
\begin{dcases}
\begin{align*}
1 - \frac{x + x^3 p_{s0}\of{x^2}}{\sin x} &= \gh_0 &\abs{\gh_0} < 2^{-75.538} \\
\round{x^3 p_{s0}\of{x^2}} &= \pa{1 + \gh_1}\pa{x^3 p_{s0}\of{x^2}} &\gh_1 \in \intopen{-2^{-50.830}}{2^{-51.192}}
\end{align*}
\end{dcases}
\]
