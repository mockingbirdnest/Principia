...
The first step of the computation is to evaluate $h \; c_k + s_k$ with extra accuracy.  See \nameref{firstorder} for the analysis of this computation:
\[
...
The first step of the computation is to evaluate $-h \; s_k + c_k$ with extra accuracy.  See \nameref{firstorder} for the analysis of this computation:
\[
