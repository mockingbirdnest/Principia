...
\label{eqnpitwoterms}
\end{align}
With the chosen value of $\gk_1$, this error turns out to be significantly smaller the theoretical bound thanks to the bit pattern of $\Pi$: a numerical computation taking into account the actual value of $\Pi$ shows that it is less that $2^{-103.217}$.
