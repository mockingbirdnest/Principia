...
\begin{align*}
\abs{c_k h} &< 2^M \ULP\of{x_k} &\implies \gd p &< \frac{1}{2} \ULP\of{c_k h} < \ULP\of{x_k} \\
s_k + c_k h &< 2^{M + 1} \ULP\of{x_k} &\implies \gd q &< \frac{1}{2} \ULP\of{s_k + c_k h} < 2 \ULP\of{x_k}
\end{align*}
we deduce that $\gd p + \gd q < 3 \ULP\of{x_k}$ and:
\[
