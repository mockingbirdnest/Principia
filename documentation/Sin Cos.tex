...
If $x \in \intclos{\pa{2 k - 1}\gD}{\pa{2 k + 1}\gD}$ and $h = x - x_k$ the steps of the computation are as follows:\marginnote{TODO(phl): Align the notation in the notebook.}
\[
\begin{dcases}
t_1\of{h} &\DefineAs h c_k + s_k \\
t_2\of{h, \gd h} &\DefineAs \round{h \round{h + 2 \gd h}} \\
...
t_{10}\of{h, \gd h} &\DefineAs \round{t_9\of{h, \gd h} + t_1\of{h, \gd h}.error} \\
y &= t_1\of{h, \gd h}.value \\
