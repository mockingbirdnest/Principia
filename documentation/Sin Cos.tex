...
\label{eqnpitwoterms}
\end{align}
In practice this quantity is smaller than $2^{-103.217}$ (which is much tighter than the theoretical bound) because of the actual bit pattern of $\Pi$.
...
\end{align*}
where we have used the upper bound for $\gd C_1$ given by equation (\ref{eqnabsdc1}).  In practice this quantity is smaller than $2^{-92.719}$.
