...
In this scheme we use a two-term approximation of the modulus as $\pa{C_1, C_2}$.  Using our notation, the algorithm proceeds as follows:
\[
\begin{dcases}
...
\end{dcases}
\]
where $C_3 = \round{\frac{\Pi}{2} - C_1 - C_2} \leq 2^{-2 M + 4} \pa{1 + \gd_1}$.
