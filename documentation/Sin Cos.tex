...
\todo{Revise all the places that assume Cody-Waite.}
\end{sloppypar}
...
\todo{Include $\gd \red x$ in this analysis and do the same for Cody-Waite.}
\[
...
\abs{\gz_1 \; \pa{x - n \pa{C_1 + C_2}}} &= \gz_1 \; \abs{\red x + \gd \red x} \leq \abs{n} \; 2^{\gk_3 - 3 M + 5} \\
...
\begin{align*}
\abs{\mathscr{E}} &\leq \abs{n} \; \pa{\gd_1 \pa{2 + \gd_1 + \frac{\pa{1 + \gd_1}^2}{\gd_1} 2^{-2 M + 1}} \; 2^{-2 M + 4} + 2^{\gk_3 - 3 M + 5}} \\
&\leq \abs{n} \; \pa{3 \times 2^{-3 M + 4} + 2^{\gk_3 - 3 M + 5}} = 2^{-3 M + 4} \pa{3 + 2^{\gk_3 + 1}}
\end{align*}
where we have used the fact that the inner term of the first line is less than $3$.
