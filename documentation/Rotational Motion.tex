...
To compute the angular velocity, we derive the equations (\ref{eqnFBN}) and obtain:
\begin{equation}
\begin{dcases}
\dot{\vF} &= \dot{\vr} \\
...
To compute the angular acceleration, we derive the equations (\ref{eqndFBN}) and obtain:
\begin{equation}
\begin{dcases}
\ddot{\vF} &= \ddot{\vr} \\
