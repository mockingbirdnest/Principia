...
&=f\of{x_0} - h f\der\of{x_0} + \sum{m = 2}[\infty]{\frac{f^{(m)}\of{x_0}}{\Factorial{m}} \pa{-1}^m h^m} \label{eqntaylorinfty} \\
...
and we replace $f\der\of{x_0}$ with its value from equation (\ref{eqntaylorinfty}):
\begin{align*}
f\der\of{x_0 + h} &= \frac{1}{h} \pa{f\of{x_0} - f\of{x_0 -h}} + \sum{m = 2}[\infty]{\frac{h^{m - 1}}{\Factorial{\pa{m - 1}}} \pa{1 + \frac{\pa{-1}^m}{m}} f^{(m)}\of{x_0}} \\
&= \frac{1}{h} \pa{f\of{x_0} - f\of{x_0 -h}} + \sum{m = 2}[\infty]{\frac{h^{m - 1}}{\Factorial{\pa{m - 1}}} \pa{1 + \frac{\pa{-1}^m}{m}} f^{(m)}\of{x_0}} + \BigO\of{h^n}
\end{align*}
