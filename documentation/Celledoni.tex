...
of time to reach the point $\tuple{0, G, 0}$; furthermore, the motion is unstable as any perturbation will move it either to
the blue or the red region; in this case $\vm$ oscillates between points close to $\tuple{0, G, 0}$ and $\tuple{0, -G, 0}$, which is 
