...
different coordinate systems.  Therefore, we view $\mathscr P_t$ as transforming $\vm$ in the coordinate system $\mathscr B^b$ of the body into $\vm$
in the coordinate system $\mathscr B_t$.  Confusingly, \cite{Celledoni2007} appear to use passive rotations when they write matrices, so their $P_t$
has semantics similar to that of our $\mathscr P_t$.
