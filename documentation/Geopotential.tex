...
\end{dcases}
\]
The value of $\cos m \gl$ and $\sin m \gl$ may similarly be computed using elementary trigonometric identities with roughly $\BigO\of {m^2}$ rounding errors.  If $m$ is even, we have:
\[
\begin{dcases}
h = \frac m 2 \\
