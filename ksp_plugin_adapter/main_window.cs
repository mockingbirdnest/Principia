...
internal class MainWindow : VesselSupervisedWindowRenderer {
  ...
  private const string next_release_name = "Grothendieck";
  private const int next_release_lunation_number = 267;
  private readonly DateTimeOffset next_release_date_ =
      new DateTimeOffset(2021, 08, 08, 13, 51, 00, TimeSpan.Zero);
