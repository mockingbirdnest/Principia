...
internal static partial class Interface {
  ...
  [DllImport(dllName           : dll_path,
             EntryPoint        = "principia__PhysicsBubbleDisplacementCorrection",
             CallingConvention = CallingConvention.Cdecl)]
  internal static extern XYZ PhysicsBubbleDisplacementCorrection(
      this IntPtr plugin,
      XYZ sun_position);

  [DllImport(dllName           : dll_path,
             EntryPoint        = "principia__PhysicsBubbleVelocityCorrection",
             CallingConvention = CallingConvention.Cdecl)]
  internal static extern XYZ PhysicsBubbleVelocityCorrection(
      this IntPtr plugin,
