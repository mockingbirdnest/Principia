...
internal partial struct BodyParameters {
  ...
  private BodyGeopotentialCoefficient[] geopotential_cos_;
  private int geopotential_cos_size_;
  public BodyGeopotentialCoefficient[] geopotential_cos {
    get { return geopotential_cos_; }
    set { geopotential_cos_ = value; geopotential_cos_size_ = value?.Length ?? 0; }
  }
  private BodyGeopotentialCoefficient[] geopotential_sin_;
  private int geopotential_sin_size_;
  public BodyGeopotentialCoefficient[] geopotential_sin {
    get { return geopotential_sin_; }
    set { geopotential_sin_ = value; geopotential_sin_size_ = value?.Length ?? 0; }
  }
}
