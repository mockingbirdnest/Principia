...
std::unique_ptr<SolarSystem> SolarSystem::AtСпутникLaunch() {
  ...
  Body const& sun      = *trajectories[0];
  Body const& jupiter  = *trajectories[1];
  Body const& saturn   = *trajectories[2];
  Body const& neptune  = *trajectories[3];
  Body const& uranus   = *trajectories[4];
  Body const& earth    = *trajectories[5];
  Body const& venus    = *trajectories[6];
  Body const& mars     = *trajectories[7];
  Body const& mercury  = *trajectories[8];
  Body const& ganymede = *trajectories[9];
  Body const& titan    = *trajectories[10];
  Body const& callisto = *trajectories[11];
  Body const& io       = *trajectories[12];
  Body const& moon     = *trajectories[13];
  Body const& europa   = *trajectories[14];
  Body const& triton   = *trajectories[15];
  Body const& eris     = *trajectories[16];
  Body const& pluto    = *trajectories[17];
  ...
  trajectories_at_спутник_launch_time_.emplace_back(sun_trajectory);
  trajectories_at_спутник_launch_time_.emplace_back(jupiter_trajectory);
  trajectories_at_спутник_launch_time_.emplace_back(saturn_trajectory);
  trajectories_at_спутник_launch_time_.emplace_back(neptune_trajectory);
  trajectories_at_спутник_launch_time_.emplace_back(uranus_trajectory);
  trajectories_at_спутник_launch_time_.emplace_back(earth_trajectory);
  trajectories_at_спутник_launch_time_.emplace_back(venus_trajectory);
  trajectories_at_спутник_launch_time_.emplace_back(mars_trajectory);
  trajectories_at_спутник_launch_time_.emplace_back(mercury_trajectory);
  trajectories_at_спутник_launch_time_.emplace_back(ganymede_trajectory);
  trajectories_at_спутник_launch_time_.emplace_back(titan_trajectory);
  trajectories_at_спутник_launch_time_.emplace_back(callisto_trajectory);
  trajectories_at_спутник_launch_time_.emplace_back(io_trajectory);
  trajectories_at_спутник_launch_time_.emplace_back(moon_trajectory);
  trajectories_at_спутник_launch_time_.emplace_back(europa_trajectory);
  trajectories_at_спутник_launch_time_.emplace_back(triton_trajectory);
  trajectories_at_спутник_launch_time_.emplace_back(eris_trajectory);
  trajectories_at_спутник_launch_time_.emplace_back(pluto_trajectory);
}

SolarSystem::SolarSystem()
    : // Number of days since the JD epoch. JD2436116.3115 is the time of the
      // launch of Простейший Спутник-1.
      спутник_launch_time_(2436116.3115 * si::Day) {
  typedef Vector<Length, ICRFJ2000EclipticFrame> Position;
  typedef Vector<Speed, ICRFJ2000EclipticFrame> Velocity;
...
SolarSystem::trajectories_at_спутник_launch_time() const {
  physics::NBodySystem<ICRFJ2000EclipticFrame>::Trajectories result;
  for (auto const& trajectory : trajectories_at_спутник_launch_time_) {
    result.push_back(trajectory.get());
  }
  return result;
}

Time const& SolarSystem::спутник_launch_time() {
}
...
SolarSystemAtСпутникLaunch() {
  ...
  Time const спутник_launch_time_ = kСпутникLaunchDate;
