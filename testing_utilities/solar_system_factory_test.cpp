...
TEST_F(SolarSystemFactoryTest, Name) {
  ...
  for (int i = SolarSystemFactory::kSun; i <= SolarSystemFactory::kTethys; ++i) {
...
TEST_F(SolarSystemFactoryTest, Parent) {
  ...
  for (int i = SolarSystemFactory::kSun + 1; i <= SolarSystemFactory::kTethys; ++i) {
    parent_names.push_back(SolarSystemFactory::name(SolarSystemFactory::parent(i)));
  }
