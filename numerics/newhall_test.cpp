...
class NewhallTest : public ::testing::Test {
 protected:
  ...
  // TODO(phl): These two functions are generally useful, move them to
  // testing_utilities.
  ...
  void CheckNewhallApproximationErrors(
      ...
      Length const& expected_length_error_estimate,
      Length const& expected_length_absolute_error,
      Speed const& expected_speed_absolute_error) {
    ...
    if (length_error_estimate != 0.0 * Metre) {
      EXPECT_THAT(Abs(length_error_estimate),
                  NearLength(expected_length_error_estimate));
    }
    EXPECT_THAT(length_absolute_error,
                NearLength(expected_length_absolute_error));
    EXPECT_THAT(speed_absolute_error,
                NearSpeed(expected_speed_absolute_error));
  }
...
TEST_F(NewhallTest, ApproximationInЧебышёвBasis_1_4) {
  CheckNewhallApproximationErrors<ЧебышёвAdapter<4>>(
      length_function_1_,
      speed_function_1_,
      /*expected_length_error_estimate=*/1.8e1 * Metre,
      /*expected_length_absolute_error=*/4.7e1 * Metre,
      /*expected_speed_absolute_error=*/1.3e2 * Metre / Second);
}
...
TEST_F(NewhallTest, ApproximationInЧебышёвBasis_1_5) {
  CheckNewhallApproximationErrors<ЧебышёвAdapter<5>>(
      length_function_1_,
      speed_function_1_,
      /*expected_length_error_estimate=*/8.3e0 * Metre,
      /*expected_length_absolute_error=*/4.3e1 * Metre,
      /*expected_speed_absolute_error=*/1.2e2 * Metre / Second);
}
...
TEST_F(NewhallTest, ApproximationInЧебышёвBasis_1_6) {
  CheckNewhallApproximationErrors<ЧебышёвAdapter<6>>(
      length_function_1_,
      speed_function_1_,
      /*expected_length_error_estimate=*/1.4e0 * Metre,
      /*expected_length_absolute_error=*/3.8e1 * Metre,
      /*expected_speed_absolute_error=*/1.1e2 * Metre / Second);
}
...
TEST_F(NewhallTest, ApproximationInЧебышёвBasis_1_7) {
  CheckNewhallApproximationErrors<ЧебышёвAdapter<7>>(
      length_function_1_,
      speed_function_1_,
      /*expected_length_error_estimate=*/7.5e0 * Metre,
      /*expected_length_absolute_error=*/1.5e1 * Metre,
      /*expected_speed_absolute_error=*/4.5e1 * Metre / Second);
}
...
TEST_F(NewhallTest, ApproximationInЧебышёвBasis_1_8) {
  CheckNewhallApproximationErrors<ЧебышёвAdapter<8>>(
      length_function_1_,
      speed_function_1_,
      /*expected_length_error_estimate=*/4.2e0 * Metre,
      /*expected_length_absolute_error=*/6.3e0 * Metre,
      /*expected_speed_absolute_error=*/2.8e1 * Metre / Second);
}
...
TEST_F(NewhallTest, ApproximationInЧебышёвBasis_1_9) {
  CheckNewhallApproximationErrors<ЧебышёвAdapter<9>>(
      length_function_1_,
      speed_function_1_,
      /*expected_length_error_estimate=*/3.1e-1 * Metre,
      /*expected_length_absolute_error=*/4.9e0 * Metre,
      /*expected_speed_absolute_error=*/2.2e1 * Metre / Second);
}
...
TEST_F(NewhallTest, ApproximationInЧебышёвBasis_1_10) {
  CheckNewhallApproximationErrors<ЧебышёвAdapter<10>>(
      length_function_1_,
      speed_function_1_,
      /*expected_length_error_estimate=*/7.5e-1 * Metre,
      /*expected_length_absolute_error=*/6.5e-1 * Metre,
      /*expected_speed_absolute_error=*/3.6e0 * Metre / Second);
}
...
TEST_F(NewhallTest, ApproximationInЧебышёвBasis_1_11) {
  CheckNewhallApproximationErrors<ЧебышёвAdapter<11>>(
      length_function_1_,
      speed_function_1_,
      /*expected_length_error_estimate=*/1.8e-1 * Metre,
      /*expected_length_absolute_error=*/2.0e-1 * Metre,
      /*expected_speed_absolute_error=*/1.6e0 * Metre / Second);
}
...
TEST_F(NewhallTest, ApproximationInЧебышёвBasis_1_12) {
  CheckNewhallApproximationErrors<ЧебышёвAdapter<12>>(
      length_function_1_,
      speed_function_1_,
      /*expected_length_error_estimate=*/4.9e-2 * Metre,
      /*expected_length_absolute_error=*/7.9e-2 * Metre,
      /*expected_speed_absolute_error=*/7.3e-1 * Metre / Second);
}
...
TEST_F(NewhallTest, ApproximationInЧебышёвBasis_1_13) {
  CheckNewhallApproximationErrors<ЧебышёвAdapter<13>>(
      length_function_1_,
      speed_function_1_,
      /*expected_length_error_estimate=*/2.6e-2 * Metre,
      /*expected_length_absolute_error=*/1.3e-2 * Metre,
      /*expected_speed_absolute_error=*/1.3e-1 * Metre / Second);
}
...
TEST_F(NewhallTest, ApproximationInЧебышёвBasis_1_14) {
  CheckNewhallApproximationErrors<ЧебышёвAdapter<14>>(
      length_function_1_,
      speed_function_1_,
      /*expected_length_error_estimate=*/8.9e-4 * Metre,
      /*expected_length_absolute_error=*/1.6e-2 * Metre,
      /*expected_speed_absolute_error=*/1.5e-1 * Metre / Second);
}
...
TEST_F(NewhallTest, ApproximationInЧебышёвBasis_1_15) {
  CheckNewhallApproximationErrors<ЧебышёвAdapter<15>>(
      length_function_1_,
      speed_function_1_,
      /*expected_length_error_estimate=*/1.6e-3 * Metre,
      /*expected_length_absolute_error=*/4.3e-3 * Metre,
      /*expected_speed_absolute_error=*/4.4e-2 * Metre / Second);
}
...
TEST_F(NewhallTest, ApproximationInЧебышёвBasis_1_16) {
  CheckNewhallApproximationErrors<ЧебышёвAdapter<16>>(
      length_function_1_,
      speed_function_1_,
      /*expected_length_error_estimate=*/2.9e-4 * Metre,
      /*expected_length_absolute_error=*/1.7e-3 * Metre,
      /*expected_speed_absolute_error=*/1.8e-2 * Metre / Second);
}
...
TEST_F(NewhallTest, ApproximationInЧебышёвBasis_1_17) {
  CheckNewhallApproximationErrors<ЧебышёвAdapter<17>>(
      length_function_1_,
      speed_function_1_,
      /*expected_length_error_estimate=*/3.7e-5 * Metre,
      /*expected_length_absolute_error=*/7.6e-4 * Metre,
      /*expected_speed_absolute_error=*/8.2e-3 * Metre / Second);
}
...
TEST_F(NewhallTest, ApproximationInЧебышёвBasis_2_3) {
  CheckNewhallApproximationErrors<ЧебышёвAdapter<3>>(
      length_function_2_,
      speed_function_2_,
      /*expected_length_error_estimate=*/7.9e-1 * Metre,
      /*expected_length_absolute_error=*/2.0e0 * Metre,
      /*expected_speed_absolute_error=*/1.8e0 * Metre / Second);
}
...
TEST_F(NewhallTest, ApproximationInЧебышёвBasis_2_4) {
  CheckNewhallApproximationErrors<ЧебышёвAdapter<4>>(
      length_function_2_,
      speed_function_2_,
      /*expected_length_error_estimate=*/2.5e-1 * Metre,
      /*expected_length_absolute_error=*/2.9e-1 * Metre,
      /*expected_speed_absolute_error=*/4.6e-1 * Metre / Second);
}
...
TEST_F(NewhallTest, ApproximationInЧебышёвBasis_2_5) {
  CheckNewhallApproximationErrors<ЧебышёвAdapter<5>>(
      length_function_2_,
      speed_function_2_,
      /*expected_length_error_estimate=*/5.7e-2 * Metre,
      /*expected_length_absolute_error=*/3.6e-2 * Metre,
      /*expected_speed_absolute_error=*/7.4e-2 * Metre / Second);
}
...
TEST_F(NewhallTest, ApproximationInЧебышёвBasis_2_6) {
  CheckNewhallApproximationErrors<ЧебышёвAdapter<6>>(
      length_function_2_,
      speed_function_2_,
      /*expected_length_error_estimate=*/8.6e-3 * Metre,
      /*expected_length_absolute_error=*/2.3e-3 * Metre,
      /*expected_speed_absolute_error=*/6.0e-3 * Metre / Second);
}
...
TEST_F(NewhallTest, ApproximationInЧебышёвBasis_2_7) {
  CheckNewhallApproximationErrors<ЧебышёвAdapter<7>>(
      length_function_2_,
      speed_function_2_,
      /*expected_length_error_estimate=*/6.2e-4 * Metre,
      /*expected_length_absolute_error=*/2.9e-14 * Metre,
      /*expected_speed_absolute_error=*/2.5e-14 * Metre / Second);
}
...
TEST_F(NewhallTest, ApproximationInЧебышёвBasis_2_8) {
  CheckNewhallApproximationErrors<ЧебышёвAdapter<8>>(
      length_function_2_,
      speed_function_2_,
      /*expected_length_error_estimate=*/4.5e-16 * Metre,
      /*expected_length_absolute_error=*/2.9e-14 * Metre,
      /*expected_speed_absolute_error=*/2.2e-14 * Metre / Second);
}
...
TEST_F(NewhallTest, ApproximationInЧебышёвBasis_2_9) {
  CheckNewhallApproximationErrors<ЧебышёвAdapter<9>>(
      length_function_2_,
      speed_function_2_,
      /*expected_length_error_estimate=*/4.8e-16 * Metre,
      /*expected_length_absolute_error=*/2.9e-14 * Metre,
      /*expected_speed_absolute_error=*/2.2e-14 * Metre / Second);
}
...
TEST_F(NewhallTest, ApproximationInЧебышёвBasis_2_10) {
  CheckNewhallApproximationErrors<ЧебышёвAdapter<10>>(
      ...
      speed_function_2_,
      /*expected_length_error_estimate=*/4.8e-16 * Metre,
      /*expected_length_absolute_error=*/4.3e-14 * Metre,
      /*expected_speed_absolute_error=*/2.9e-14 * Metre / Second);
}
...
TEST_F(NewhallTest, ApproximationInЧебышёвBasis_2_11) {
  CheckNewhallApproximationErrors<ЧебышёвAdapter<11>>(
      ...
      /*expected_length_absolute_error=*/3.6e-14 * Metre,
      /*expected_speed_absolute_error=*/2.2e-14 * Metre / Second);
}
...
TEST_F(NewhallTest, ApproximationInЧебышёвBasis_2_12) {
  CheckNewhallApproximationErrors<ЧебышёвAdapter<12>>(
      length_function_2_,
      speed_function_2_,
      /*expected_length_error_estimate=*/7.3e-16 * Metre,
      /*expected_length_absolute_error=*/2.9e-14 * Metre,
      /*expected_speed_absolute_error=*/2.9e-14 * Metre / Second);
}
...
TEST_F(NewhallTest, ApproximationInЧебышёвBasis_2_13) {
  CheckNewhallApproximationErrors<ЧебышёвAdapter<13>>(
      ...
      /*expected_length_absolute_error=*/1.5e-14 * Metre,
      /*expected_speed_absolute_error=*/6.1e-14 * Metre / Second);
}
...
TEST_F(NewhallTest, ApproximationInЧебышёвBasis_2_14) {
  CheckNewhallApproximationErrors<ЧебышёвAdapter<14>>(
      length_function_2_,
      speed_function_2_,
      /*expected_length_error_estimate=*/2.1e-16 * Metre,
      /*expected_length_absolute_error=*/1.5e-14 * Metre,
      /*expected_speed_absolute_error=*/6.8e-14 * Metre / Second);
}
...
TEST_F(NewhallTest, ApproximationInЧебышёвBasis_2_15) {
  CheckNewhallApproximationErrors<ЧебышёвAdapter<15>>(
      length_function_2_,
      speed_function_2_,
      /*expected_length_error_estimate=*/3.2e-16 * Metre,
      /*expected_length_absolute_error=*/2.9e-14 * Metre,
      /*expected_speed_absolute_error=*/3.5e-13 * Metre / Second);
}
...
TEST_F(NewhallTest, ApproximationInЧебышёвBasis_2_16) {
  CheckNewhallApproximationErrors<ЧебышёвAdapter<16>>(
      ...
      /*expected_length_absolute_error=*/2.9e-14 * Metre,
      /*expected_speed_absolute_error=*/8.5e-13 * Metre / Second);
}
...
TEST_F(NewhallTest, ApproximationInMonomialBasis_2_8) {
  CheckNewhallApproximationErrors<MonomialAdapter<8>>(
      ...
      speed_function_2_,
      /*expected_length_error_estimate=*/4.5e-16 * Metre,
      /*expected_length_absolute_error=*/3.9e-14 * Metre,
      /*expected_speed_absolute_error=*/1.3e-13 * Metre / Second);
}
...
TEST_F(NewhallTest, ApproximationInMonomialBasis_2_9) {
  CheckNewhallApproximationErrors<MonomialAdapter<9>>(
      ...
      speed_function_2_,
      /*expected_length_error_estimate=*/4.8e-16 * Metre,
      /*expected_length_absolute_error=*/1.0e-13 * Metre,
      /*expected_speed_absolute_error=*/4.8e-13 * Metre / Second);
}
...
TEST_F(NewhallTest, ApproximationInMonomialBasis_2_10) {
  CheckNewhallApproximationErrors<MonomialAdapter<10>>(
      ...
      speed_function_2_,
      /*expected_length_error_estimate=*/4.8e-16 * Metre,
      /*expected_length_absolute_error=*/3.5e-13 * Metre,
      /*expected_speed_absolute_error=*/7.1e-13 * Metre / Second);
}
...
TEST_F(NewhallTest, ApproximationInMonomialBasis_2_12) {
  CheckNewhallApproximationErrors<MonomialAdapter<12>>(
      ...
      speed_function_2_,
      /*expected_length_error_estimate=*/7.3e-16 * Metre,
      /*expected_length_absolute_error=*/1.3e-11 * Metre,
      /*expected_speed_absolute_error=*/5.4e-11 * Metre / Second);
}
...
TEST_F(NewhallTest, ApproximationInMonomialBasis_2_14) {
  CheckNewhallApproximationErrors<MonomialAdapter<14>>(
      ...
      speed_function_2_,
      /*expected_length_error_estimate=*/2.1e-16 * Metre,
      /*expected_length_absolute_error=*/8.1e-12 * Metre,
      /*expected_speed_absolute_error=*/5.1e-11 * Metre / Second);
}
...
TEST_F(NewhallTest, ApproximationInMonomialBasis_2_15) {
  CheckNewhallApproximationErrors<MonomialAdapter<15>>(
      ...
      speed_function_2_,
      /*expected_length_error_estimate=*/3.2e-16 * Metre,
      /*expected_length_absolute_error=*/3.0e-10 * Metre,
      /*expected_speed_absolute_error=*/1.7e-9 * Metre / Second);
}
