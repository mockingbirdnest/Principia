...
constexpr double sin_near_zero_e = 0x1.0000'AAD0'391A'Dp0;  // 2^-70.583.
constexpr double sin_e = 0x1.0002'6751'2409'6p0;  // 2^-68.734.
constexpr double cos_e = 0x1.0001'B838'5D35'1p0;  // 2^-69.217.
